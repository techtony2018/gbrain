...
const resolver_events_submit: Operation = {
  ...
  params: {
    ...
    environment: { type: 'string', description: 'production | test | development | synthetic' },
    synthetic: { type: 'boolean' },
    test_run: { type: 'boolean' },
    pair_id: { type: 'string', description: 'Privacy-safe before/after or dispatch/outcome correlation id.' },
  },
